...
<body  ng-controller="TodoListController as todoList">
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form>
        <input type="text" class="fadeIn second" name="login" placeholder="login" ng-model="todoList.data.user">
        <input type="password" class="fadeIn third" name="login" placeholder="password" ng-model="todoList.data.pass">
        <input type="submit" class="fadeIn fourth" value="Log In" ng-click="todoList.login()">
      </form>
      <div id="formFooter">
